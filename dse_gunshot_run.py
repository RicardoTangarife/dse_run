...
filenameOutput = 'output/dse_gunshot_times.json'
soundTestPath = 'audio_test/gunshot_test.wav'

initialCommandSCP = "scp -r -J rtangarife@200.24.23.71:22666 rtangarife@gita-srv-002:Mfcc_hyperparameters_search/output/models/gunshot_models"
      ...
      for iterableNhopL in valuesHopL:            #Loop para variar valores del parametro Hop_Length => 1/Overlaping
        ...
        for k_size in valuesKernelSize:           #Loop para variar valores del parametro kernel size => Tamaño del kernel de capas convolucionales
          ...
          for i in range(5):                        #Loop para promediar el experimento realizandolo 5 veces con los mismos valores de parametros
            ...
            #TOTAL TF MODEL
            modelNamePath = f"/Saved_Gunshot_NExp{NExp}_Rep{i+1}"
            ...
            #TF LITE MODEL
            modelNamePath = f"/Saved_Gunshot_NExp{NExp}_Rep{i+1}_lite.tflite"
            totalCommand = initialCommandSCP+modelNamePath+f" {folder_path_models}"+modelNamePath
            #print(totalCommand)
            ...
            modelPath =  folder_path_models+f"/Saved_Gunshot_NExp{NExp}_Rep{i+1}"
            ...
            modelPathTFLite =  folder_path_models+f"/Saved_Gunshot_NExp{NExp}_Rep{i+1}_lite.tflite"
